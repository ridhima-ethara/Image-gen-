...
import { DesignSchema, validateDesign, TEMPLATES, CHART_TYPES, THEMES, CANVASES, PLACEMENTS } from './schema.js';
...
if (process.argv.includes('--catalog')) {
  console.log(JSON.stringify({ templates: TEMPLATES, chartTypes: CHART_TYPES, themes: THEMES, canvases: Object.keys(CANVASES), placements: Object.keys(PLACEMENTS) }));
  process.exit(0);
}
